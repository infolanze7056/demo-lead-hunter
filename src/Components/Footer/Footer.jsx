...
function Footer() {
  return (
    <div className='font-family bg-[--main-color]'>
      <div className="pt-16 mx-auto lg:px-28 md:px-10 px-4">
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
        <img className='w-6 h-6' src={logo} alt="Lead" />
        <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Lead Hunter</span>
      </a>
    ...
    <div className="space-y-2 text-sm">
      ...
      <div className="flex">
        ...
        <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">infolanze.tech@gmail.com</a>
      </div>
      <div className="flex">
    ...
    <div className='lg:px-2'>
      ...
      <div className="flex items-center mt-1 space-x-3">
        <a href="/" className="text-gray-500 transition-colors duration-200 hover:text-black">
  ...
  <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
    <p className="text-sm text-gray-600">
      © Copyright 2024 Lead Hunter. All rights reserved.
    </p>
