  ...
  return (
    <div className="font-family">
      <div className="lg:px-20 md:px-20 px-4 py-10">
        <h1 className="text-center text-2xl pb-2">Privacy Policy</h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Lead Hunter.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Lead Hunter, accessible from{" "}
              <a
                href="https://www.leadhunter.co.in/"
                // rel="external nofollow noopener"
                target="_blank"
                rel="noreferrer"
              >
                https://www.leadhunter.co.in/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: infolanze.tech@gmail.com</li>
        </ul>
      </div>
    </div>
  );
